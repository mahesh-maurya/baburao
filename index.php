                        ...
                        <div class="head-right">
                            ...
                            <div class="text-right">
                                <div class="rgh-txt">
                                    ...
                                    <input class="in-right" type="text" placeholder="Enter email address">
                                    <button class="btn-right" type="sunmit">submit</button>
                                </div>
            ...
            <div class="row scocial-set">
                <div class="col-md-4">
                    <div class="fb">
                        ...
                        <div class="fb-st">
                       <div class="fb-page" data-href="https://www.facebook.com/localbanya" data-width="100%" data-height="360" data-hide-cover="false" data-show-facepile="false" data-show-posts="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/localbanya"><a href="https://www.facebook.com/localbanya">Local Banya</a></blockquote></div></div>
                    </div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="list-set scroll">
                            ...
                            <div class="col-xs-6">
                                ...
                                <ul>
                                    <li>Surprises Round the Corner!</li>
                                    <li>#ThreeMuch</li>
                                    <li>#ThreeMuch</li>
                                    <li>Happy Birthday Localbanya!</li>
                                    <li>#ContestAlert</li>
                                    <li>#ThreeMuch</li>
                                    <li>#NewWeeklyOffer</li>
                                    <li>Order to receive a #FreeBite!</li>
                                    <li>#ContestAlert Mother's Day</li>
                                    <li>#ContestAlert</li>
                                    <li>#ContestAlert</li>
                                    <li>#ContestAlert</li>
                                    <li>#NewWeeklyOffer</li>
